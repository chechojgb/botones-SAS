    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-start lg:gap-8">
            ...
            <div class="p-4 flex grayscale transition duration-200 hover:grayscale-0">
                <img src="./images/logoBotones.png" class="h-8 w-auto m-auto" loading="lazy" alt="client logo" />
            </div>
          ...
          <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div class="col-span-2">
              <div>
                <h2 class="text-2xl font-bold text-blues-400 dark:text-neutral">Get the latest news!</h2>
    
                <p class="mt-4 text-blues-500 dark:text-neutral" >
            ...
            <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end dark:text-white">
            </div>
        ...
        <div class="mt-8 border-t border-gray-100 pt-8">
          <div class="sm:flex sm:justify-between dark:text-white" >
